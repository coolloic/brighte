...
| Route | What |
|---|---|
| `/` | Registration form. Service options come from the API (`serviceTypes`), so a new service appears without a deploy (within 5 minutes: see below) |
